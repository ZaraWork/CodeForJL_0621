...
{
    public partial class PM_Bill_StaticTrain_Mats_NewForm : CoreForm
    {
        #region 实例变量
        ...
        #region 构造函数
        public PM_Bill_StaticTrain_Mats_NewForm()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void cleandata()
        {
            ...
            txt_ShibieCarNo.EditValue = null;
            lb_weight.Text = "0";
        ...
        private void PM_Bill_StaticTrain_Mats_Form_Shown(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //{
                //    ShowTxtLog(seat.SiteName + "--静态坐席初始化成功");
                //}
                ShowTxtLog("初始化成功！");
            }
                ...
                if (txt_BillStatus.Text != string.Empty)
                {
                    if (txt_BillStatus.Text == "未计量")
                    {
                        ...
                        if (supplies != null)
                        {
                            ...
                            //7.21 新增配置字段
                            bill.ShipName = supplies.ShipName;
                            bill.Plan_Id = supplies.Plan_ID;
                            bill.DeclarationNo = supplies.DeclarationNo;
                    ...
                    else
                    {
                        if (pond != null)
                        {
                            ...
                            pond.NetWgtTime = DateTime.Now.ToString("yyyyMMddHHmmss");
            ...
            try
            {
                ...
                if (PondSite_Monitorfactory != null)
                {
                    if (pondSiteMonitorWCFservice == null)
                    {
                        ...
                        var rs = pondSiteMonitorWCFservice.QueryMonitorById(pondSiteInfo.IntId);
                        lb_weight.Text = (rs.MeterOneWeight / 1000).ToString();
                        txt_ShibieCarNo.Text = Convert.ToInt32(rs.MeterTwoWeight).ToString();
