...
{
    public partial class IT_TrackScaleIronPlan_Form : CoreForm
    {
        public IT_TrackScaleIronPlan selectMainEntity { get; set; }
        public IIT_TrackScaleIronPlanService MainService { get; set; }
        //private Color MM = Color.Green;
        public IT_TrackScaleIronPlan_Form()
        {
            InitializeComponent();
        }
        ...
        private void btn_Query_Click(object sender, EventArgs e)
        {
            ...
            IList<IT_TrackScaleIronPlan> rss= MainService.ExecuteDB_QueryIT_TrackScaleIronPlan(ht);
            if (rss != null)
            {
                List<IT_TrackScaleIronPlan> data = rss.ToList();
                data.ForEach(r =>
                {
        ...
        {
            IT_TrackScaleIronPlan item = gvw_main.GetRow(e.RowHandle) as IT_TrackScaleIronPlan;
            if (item == null)
                return;
        ...
        private void IT_TrackScaleIronPlan_Form_Shown(object sender, EventArgs e)
        {
