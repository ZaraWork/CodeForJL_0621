...
namespace LTN.CS.SCMForm.PM
{
    public partial class PM_TruckPoundBill_Form : CoreForm
    {
        ...
        {
            if (ScaleFlag == true) { Spin_NetWgt.Value = Spin_GrossWgt.Value - Spin_TareWgt.Value; }
            else { CalcNetWeight(); } 
        }
        ...
        //小称
        private void btn_SmallScale_Click(object sender, EventArgs e)
        {
            ScaleFlag = true;
            Spin_TareWgt.Value = 0;
            Spin_NetWgt.Value = Spin_GrossWgt.Value;
            cBox_BillState.EditValue = "已完成";
            txt_GrossWgtMan.Text = SessionHelper.LogUserNickName;
            txt_TareWgtMan.Text = "";
            date_TareWgtTime.EditValue = null;
            LookUp_TareWgtSite.EditValue = null;
            Spin_GrossWgt.Properties.ReadOnly = false;
            LookUp_GrossWgtSite.Properties.ReadOnly = false;
            LookUp_TareWgtSite.Properties.ReadOnly = true;
            //date_TareWgtTime.Properties.ReadOnly = true;
            //txt_TareWgtMan.Properties.ReadOnly = true;
            //date_TareWgtTime.Text = "";
            //date_GrossWgtTime.Text = DateTime.Now.ToString();
        }
