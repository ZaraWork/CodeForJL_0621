...
namespace LTN.CS.SCMService.PT.Implement
{
    public class PT_TruckMeasurePlanServiceImpl: IPT_TruckMeasurePlanService
    {
       ...
       public PT_TruckMeasurePlan ExecuteDB_QueryTruckMeasurePlanByPlanNo(string planId)
       {
        ...
        public IList<PT_TruckMeasurePlan> ExecuteDB_QueryTruckMeasurePlanInvaliedByHashTable(Hashtable ht)
        {
            IList<PT_TruckMeasurePlan> result;
            try
            {
                result = CommonDao.ExecuteQueryForList<PT_TruckMeasurePlan>("QueryTruckMeasurePlanInvaliedByHashTable", ht);
            }
            catch (Exception ex)
            {
                log.Error(ex.Message);
        ...
        public PT_TruckMeasurePlan ExecuteDB_QueryTruckMeasurePlanByPlanNo_New(string planId)
        {
            PT_TruckMeasurePlan result;
            try
            {
                result = CommonDao.ExecuteQueryForObject<PT_TruckMeasurePlan>("SelectTruckMeasurePlanByPlanNo_New", planId);
            }
            catch (Exception ex)
            {
                log.Error(ex.Message);
        ...
        public object ExecuteDB_InsertTruckMultiPlansInfo(Hashtable ht)
        {
            object result = 1;
            try
            {
                result = CommonDao.ExecuteInsert("InsertTruckMultiPlansInfo", ht);
            }
            catch (Exception ex)
            {
                log.Error(ex.Message);
