...
// Author:kolio
// Created:2016/10/26 13:42:19
// Description:
// ***********************************************************************
// Last Modified By:kolio
// Last Modified On:2016/10/26 13:42:19
// ***********************************************************************
using System;
...
namespace LTN.CS.SCMHardSDK.ICSDK
{
    public class ICSDK
    {
        ...
        [DllImport("mwrf32.dll", EntryPoint = "rf_authentication_key", SetLastError = true,
             ...
             CallingConvention = CallingConvention.StdCall)]
        //说明：     返回设备当前状态
        public static extern Int16 rf_authentication_key(int icdev, int mode, int blocknr, [MarshalAs(UnmanagedType.LPArray)]byte[] keybuff);

        [DllImport("mwrf32.dll", EntryPoint = "rf_read", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        //说明：     返回设备当前状态
        public static extern Int16 rf_read(int icdev, UInt32 blocknr, [MarshalAs(UnmanagedType.LPArray)]byte[] databuff);
