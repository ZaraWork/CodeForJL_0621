...
{
    public partial class SM_WeightListTwo_InfoForm : CoreForm
    {
        public ISM_WeightList_InfoService MainService { get; set; }
        public SM_WeightListTwo_InfoForm()
        {
            InitializeComponent();
        }
        ...
        private void btn_Query_Click(object sender, EventArgs e)
        {
            ...
            gCtrl_TruckMeasurePlan.DataSource= MainService.ExecuteDB_QueryWeight2(ht);
        }
