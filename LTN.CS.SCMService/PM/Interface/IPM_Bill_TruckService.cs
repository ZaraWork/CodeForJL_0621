...
namespace LTN.CS.SCMService.PM.Interface
{
    public interface IPM_Bill_TruckService
    {
        ...
        IList<PM_Bill_Truck> ExecuteDB_QueryTruckIsRepeatByPlanNo(string PlanNo);
        PM_Bill_Truck ExecuteDB_QueryTruckByWgtlistNo(string WgtlistNo);
        object ExecuteDB_UpdateTruckPondByIntId(PM_Bill_Truck pond);
        object ExecuteDB_UpdateTruckHistroyDataFlagByIntId(PM_Bill_Truck_History history);
    }
}
