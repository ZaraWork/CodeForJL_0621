...
{
    public partial class XtraReportRP2 : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReportRP2()
        {
            InitializeComponent();
        ...
        private void XtraReportRP2_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
