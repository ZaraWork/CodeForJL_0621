...
namespace LTN.CS.SCMService.PM.Interface
{
    public interface IPM_Bill_BeltScaleService
    {
        ...
        IList<PM_Bill_Belt> ExecuteDB_QueryBeltHourlyPondByPlan(string planno);

        object ExecuteDB_UpdatePM_Bill_Belt_Mark(List<string> s);

        string ExecuteDB_QueryWgtlistno(string value);

        object ExecuteDB_InsertPM_Bill_Belt_ForRJ(PM_Bill_Belt bill);


        IList<PM_Bill_Belt> ExecuteDB_QueryPM_Bill_BeltByHashtable_startTime(Hashtable ht);


        IList<PM_Bill_Belt> ExecuteDB_QueryPM_Bill_BeltByHashtable_endTime(Hashtable ht);

        PM_Bill_Belt ExecuteDB_QueryPM_Bill_BeltByWgtListNo(string wgtlistno);
