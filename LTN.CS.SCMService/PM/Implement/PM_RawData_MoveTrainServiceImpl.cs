...
namespace LTN.CS.SCMService.PM.Implement
{
    public class PM_RawData_MoveTrainServiceImpl : IPM_RawData_MoveTrainService
    {
        ...
        public IList<PM_RawData_MoveTrain_New> ExecuteDB_QueryByHashTable_New(Hashtable ht)
        {
            ...
            try
            {
                // result = CommonDao.ExecuteQueryForList<PM_RawData_MoveTrain_New>("selectPM_RawData_MoveTrain_NewByCond", ht);                
                   result = CommonDao.ExecuteQueryForList<PM_RawData_MoveTrain_New>("selectPM_RawData_MoveTrain_NewByCondAddCarType", ht);
            }
            catch (Exception ex)
            {
                log.Error(ex.Message);
        ...
        public IList<PM_RawData_MovetainCarTypeAndStandardWeight> ExecuteDB_QueryPM_MovetrainCarTypeInfoAll()
        {
            IList<PM_RawData_MovetainCarTypeAndStandardWeight> result;
            try
            {                
                result = CommonDao.ExecuteQueryForList<PM_RawData_MovetainCarTypeAndStandardWeight>("selectMoveTrainCarTypeInfo",null);
            }
            catch (Exception ex)
            {
                log.Error(ex.Message);
