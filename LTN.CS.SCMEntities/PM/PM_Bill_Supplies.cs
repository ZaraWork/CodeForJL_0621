...
namespace LTN.CS.SCMEntities.PM
{
    public class PM_Bill_Supplies
    {
        ...
        public BusinessTypesObj BusinessType { get; set; }// 业务类型（0:进厂;1:出厂;2:内倒;3:火车虚拟进厂;4:采购汽运内转;8:火车集装箱进厂;）
        ...
        #region 装车楼作业计划新增
        public string ShipName { get; set; }//船名
        public string Plan_ID { get; set; }//装车外发作业号ID
        public string DeclarationNo { get; set; }//报关单号
        #endregion
